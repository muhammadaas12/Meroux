...
export default function Footer() {
    ...
    return (
        <footer className="w-full bg-[#0a0a0a] border-t border-white/10 py-4 px-7">
            <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
 
                <p className="text-xs text-white/60">
                    &copy; 2026 <span className="font-semibold text-white/80">Meroux Ltd. </span> All rights reserved.
                </p>
                <div className="flex items-center gap-5">
                    {[
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="text-white/50 hover:text-yellow-300 transition-colors duration-200 flex items-center gap-1.5 text-xs"
                        >
