        ...
        <div className="max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-white/5 p-8 rounded-2xl backdrop-blur-md">
              <h2 className="text-1xl mb-4 font-medium">Who We Are</h2>
              ...
              <h2 className="text-1xl mb-4 font-medium">Our Mission & Vision</h2>
              <p className="text-xl text-gray-100 leading-relaxed mb-5">
            ...
            {/* Right */}
            <div className="bg-white/5 p-8 rounded-2xl backdrop-blur-md">
              <h2 className="text-1xl mb-4 font-medium">Why Choose Us</h2>
              <p className="text-xl text-gray-100 leading-relaxed mb-5">
              ...
              <h2 className="text-1xl mb-4 font-medium">Our Values</h2>
